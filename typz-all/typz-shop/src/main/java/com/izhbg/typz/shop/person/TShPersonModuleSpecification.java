package com.izhbg.typz.shop.person;
...
@Component
public class TShPersonModuleSpecification implements ModuleSpecification {
	private static final String MODULE_NAME = "sh_person";
