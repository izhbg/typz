package com.izhbg.typz.shop.store;
...
@Component
public class TShStoreModuleSpecification implements ModuleSpecification {
	private static final String MODULE_NAME = "sh_store";
