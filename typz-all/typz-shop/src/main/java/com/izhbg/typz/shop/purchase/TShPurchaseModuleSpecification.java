package com.izhbg.typz.shop.purchase;
...
@Component
public class TShPurchaseModuleSpecification implements ModuleSpecification {
	private static final String MODULE_NAME = "sh_purchase";
