package com.izhbg.typz.shop.member;
...
@Component
public class TShMemberModuleSpecification implements ModuleSpecification {

	private static final String MODULE_NAME = "sh_member";
