package com.izhbg.typz.shop.order;
...
@Component
public class TShOrderModuleSpecification implements ModuleSpecification {
	private static final String MODULE_NAME = "sh_order";
