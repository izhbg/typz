...
import com.izhbg.typz.base.util.GenericsUtils;
...
public class HibernateEntityDao<T> extends HibernatePagingDao {
    ...
    public void save(Object entity) {
    	try {
    		Serializable id = getId(entity.getClass(), entity);
    ...
    @Transactional(readOnly = true)
    public List<T> findByIdsOrder(List ids,String orderString,boolean isAsc) {
    	return this.findByIdsOrder(entityClass, ids,orderString,isAsc);
    }
    /**
     * 根据name,value进行模糊查询.
     * 
