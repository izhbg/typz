...
import com.izhbg.typz.base.util.BeanUtils;
import com.izhbg.typz.base.util.ReflectUtils;
...
public class HibernateGenericDao extends HibernateBasicDao {
    ...
    @Transactional(readOnly = true)
    public <T> List<T> findByIdsOrder(Class<T> entityClass, List ids,String orderString,boolean isAsc) {
    	Assert.notEmpty(ids);
    	
    	String idName = this.getIdName(entityClass);
    	Criterion criterion = Restrictions.in(idName, ids);
    	
    	return this.createCriteria(entityClass, orderString, isAsc, criterion).list();//this.find(entityClass, criterion);
    }
    // ============================================================================================
    // getCount
    // ============================================================================================
