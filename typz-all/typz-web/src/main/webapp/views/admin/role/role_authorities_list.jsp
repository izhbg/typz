	...
	<div class="page-container">
		...
		<div class="content content-inner">
			...
			<div class="panel-heading">
				<h3 class="panel-title">角色授权资源权限【角色代码：${gnjs.gnjsDm }角色名称：${gnjs.gnjsMc }】</h3>
			</div>
				...
				<tbody >
					<c:forEach items="${page.result}" var="item">
						<tr id="${item.id}">
							...
							<td > ${item.authorities.authorityId }
							</td>
							<td>${item.authorities.authorityName}
							</td>
							<td>${item.enabled }
							</td>
						</tr>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">选择权限节点</h4>
					</div>
...
function rf_add(){
	...
	$.ajax({
		type: "POST",
	    url: "${ctx }/role_authorities/role_authorities_add.izhbg",
	    data: pars,
	    dataType:"html",
		cache: false,
...
function deleteInfo(){
	$.ajax({
		type: "POST",
	    url: "${ctx }/role_authorities/role_authorities_dell.izhbg",
