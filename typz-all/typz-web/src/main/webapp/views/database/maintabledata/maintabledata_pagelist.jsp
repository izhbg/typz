		...
		<div class="content content-inner">
			...
			<div class="panel-body">
				 <tags:permission type="create" gnDm="${sessionScope.gnDm}">
				    <a href="javascript:addObject()" class="btn btn-sm default"><i class="fa fa-plus-square"></i>新建</a> 
				 </tags:permission>
				 <tags:permission type="delete" gnDm="${sessionScope.gnDm}">
					<a href="javascript:deleteInfo()" class="btn btn-sm default"><span class="glyphicon glyphicon-calendar"></span> 删除</a> 
				 </tags:permission>
				 ...
				 <c:forEach var="buttons" items="${buttonList}">
					<c:if test="${buttons.button_target eq 'ajaxTodo'}">
						<c:if test="${buttons.button_executetype eq 1}">
							<a  class="btn default btn-sm" href="#this" onclick="useraction('${buttons.button_target}','${ctx}/default/${fn: replace(buttons.button_action,'&amp;','&')}?tableName=${maintable.tableName }&executsql=${buttons.button_sql}')">${buttons.button_name}</a>
						</c:if>
						<c:if test="${buttons.button_executetype eq 2}">
							<a class="btn default btn-sm" href="javascript:${buttons.button_action}('${fn: replace(buttons.button_sql,'&amp;','&')}')" >${buttons.button_name}</a>
						</c:if>
						<c:if test="${buttons.button_executetype eq 3}">
							<a class="btn default btn-sm" href="#this" onclick="setMenuState4session('${buttons.button_other}','${ctx}/default/${fn: replace(buttons.button_action,'&amp;','&')}','${buttons.button_name}')">${buttons.button_name}</a>
						</c:if>
					</c:if>
					<c:if test="${buttons.button_target eq 'dialog'}">
						<a  class="btn default btn-sm" href="#this" onclick="dialogInfo('${ctx}/default/${fn: replace(buttons.button_action,'&amp;','&')}?tableName=${maintable.tableName }&executsql=${buttons.button_sql}')">${buttons.button_name}</a>
					</c:if>
				 </c:forEach>
					<!--<div class="btn-group">
				...
				<div id="collapse-group" class="collapse <c:if test="${isSearch}">in</c:if> ">
					 <div class="panel panel-default" style="margin-bottom: 0px;"> 
						<div class="panel-body"> 
						<form id="searchForm" name="searchForm" method='post' action="${ctx}/maintabledata/maintabledata_pagelist.izhbg" class="form-horizontal">   
						  	<input id="maintableid" type="hidden" name="maintableid" value="${maintable.tableid }" ispost="true"/>
						  	<input id="tableName" type="hidden" name="tableName" value="${maintable.tableName }" ispost="true"/> 
						  	<input id="realtableid"name="realtableid" type="hidden" value="" ispost="true"/>
							...
							<div class="form-body">
								<c:forEach var="list" items="${queryList}" varStatus="status">
									 <c:if test="${list.type eq 6}">
								   		<input type="hidden" id="${list.name}" name="${list.name}" value="${list.value}" ispost="true"/>
								   	 </c:if>
										   ...
										   <c:set var="num" value="${num+1}"></c:set>
											<div class="col-md-6">
												<div class="form-group">
													...
													<div class="col-md-7">
														<input  type="text" id="${list.name }" name="${list.name }" value="${list.value}"  class="form-control" />
													</div>
												</div>
											</div>
									  </c:if>
									  <c:if test="${list.type eq 2}">
										   ...
										   <div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-5" >${list.cname}：</label>
													<div class="col-md-7">
														<select name="${list.name }" id="${list.name }"  class="form-control" >
														   	<option value="" >请选择</option>
														   	<c:forEach var="map" items="${list.lists}">
														   		<option value="${map.id }" <c:if test="${map.id eq list.value}">selected</c:if> >${map.name }</option>
														   	</c:forEach>
													    </select> 
													</div>
												</div>
									   ...
									   <c:if test="${list.type eq 5 and list.mainTableColumn.dataType ne 3}">
										   <c:set var="num" value="${num+1}"></c:set>
										   <div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-5" >${list.cname}：</label>
													<div class="col-md-7">
														<input  class="Wdate form-control" type="text"  runat="server" id="${list.name }" name="${list.name }" value="${fn:substring(list.value,0,19) }" size="18" onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd HH:mm:ss'})" ispost="true" isclear="true" />
													</div>
												</div>
											</div>
									   </c:if>
									   <c:if test="${list.type eq 5 and list.mainTableColumn.dataType eq 3}">
										   <c:set var="num" value="${num+1}"></c:set>
										   <div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-5" >开始${list.cname}：</label>
													<div class="col-md-7">
														<input  class="Wdate form-control" type="text"  runat="server" id="${list.name }start" name="${list.name }start" value="${fn:substring(list.startdate,0,19) }" size="18" onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd HH:mm:ss'})" ispost="true"isclear="true" />
													</div>
												</div>
											</div>
											<c:if test="${num%2 eq 0 }">
										   ...
										   <div class="col-md-6">
												<div class="form-group">
													...
													<div class="col-md-7">
														<input  class="Wdate form-control" type="text"  runat="server" id="${list.name }end" name="${list.name }end" value="${fn:substring(list.enddate,0,19) }" size="18" onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd HH:mm:ss'})" ispost="true"isclear="true" />
													</div>
												</div>
											</div>
									   </c:if>
									   <c:if test="${list.type eq 10 and list.mainTableColumn.dataType ne 3}">
										   <c:set var="num" value="${num+1}"></c:set>
										   <div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-5" >${list.cname}：</label>
													<div class="col-md-7">
														<input  class="Wdate form-control" type="text"  runat="server" id="${list.name }" name="${list.name }" value="${fn:substring(list.value,0,19) }" size="18" onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})" ispost="true"isclear="true" />
													</div>
												</div>
											</div>
									   </c:if>
										<c:if test="${list.type eq 10 and list.mainTableColumn.dataType eq 3}">
										   <c:set var="num" value="${num+1}"></c:set>
										   <div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-5" >开始${list.cname}：</label>
													<div class="col-md-7">
														<input  class="Wdate form-control" type="text"  runat="server" id="${list.name }start" name="${list.name }start" value="${fn:substring(list.startdate,0,10)}" size="18" onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})" ispost="true"isclear="true" />
													</div>
												</div>
											</div>
											<c:if test="${num%2 eq 0 }">
										   ...
										   <div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-5" >结束${list.cname}：</label>
													<div class="col-md-7">
														<input  class="Wdate form-control" type="text"  runat="server" id="${list.name }end" name="${list.name }end" value="${fn:substring(list.enddate,0,10) }" size="18" onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})" ispost="true"isclear="true" />
													</div>
												</div>
											</div>
									   </c:if>
									   <c:if test="${list.type eq 8}">
										   ...
										   <div class="col-md-6">
												<div class="form-group">
													<label class="control-label col-md-5" >${list.cname}：</label>
													<div class="col-md-7">
														<c:set var="tanchuvalue" value='${fn:split(list.value,",")}'></c:set>
														<div class="input-group userPicker">
															...
															<span class="input-group-addon add-on" onclick="openGroupWin1('${ctx}/default/management/security/maintable/gettree.do','${list.cname }','common_send_group','${list.mainTableColumn.columnid }','${list.mainTableColumn.isChecked }','${list.name }_snb')"><i class="fa fa-search"></i></span>
														</div>
													</div>
												</div>
											</div>
												...
												<div class="form-group">
													...
													<div class="col-md-7 picker" id="${list.name }"> 
														<div class="input-group">
															<input type="text" readonly="readonly" value="${list.value}" name="${list.name }" class="form-control" />
			...
			<form action="${ctx}/default/management/security/maintable/removeRealTable.do" id="gridform" method="post">
			 <table id="meeting-infoGrid"  class="table table-striped  table-hover" style="border-top: 1px solid green;">
			  ...
			  <tbody>
				<c:forEach var="resoult" items="${page.result}" varStatus="status">
				  <tr rel="realtableid=${resoult[maintable.keyColumnName]}&tableName=${maintable.tableName }">
					  <td style="text-align: center;" class="id">
						<input type="checkbox" name="realtableid" class="selectedItem a-check"  value="${resoult[maintable.keyColumnName]}"/>
					  </td>
				      <td>
				      ...
				      <c:forEach var="list" items="${viewList}" varStatus="status">
						  ...
						  <c:if test="${list.mainTableColumn.propertyType eq 7}">
							  ...
							  <c:set var="tablekey" value='${fn:split(fn:substringAfter(list.mainTableColumn.typeSql,"#"),":")}'></c:set>
							  	<a href='${ctx}/default/management/security/maintable/tableDetailView.do?${fn:substringBefore(list.mainTableColumn.typeSql,"#")}&${tablekey[0]}=${resoult[tablekey[1]]}' >${resoult[list.name] }</a>
							  </td>
						  </c:if> 

						  <c:if test="${list.mainTableColumn.propertyType eq 2 or list.mainTableColumn.propertyType eq 4 }">
							  <td width="${list.mainTableColumn.columnLength}">
								  <c:forEach var="item" items="${list.lists}">
						  ...
						  <c:if test="${list.mainTableColumn.propertyType eq 5 or (list.mainTableColumn.dataType eq 3 and list.mainTableColumn.propertyType eq 6)}">
							  <td width="${list.mainTableColumn.columnLength}">
							  ${fn:substring(resoult[list.name],0,19) }
							  </td>
						  </c:if>

						  <c:if test="${list.mainTableColumn.propertyType eq 10 }">
							  <td  width="${list.mainTableColumn.columnLength}"> 
							  ${fn:substring(resoult[list.name],0,10) }
							  </td>
						  </c:if>

						  <c:if test="${list.mainTableColumn.propertyType eq 9 }">
							  <td width="${list.mainTableColumn.columnLength}" title="${resoult[list.name] }" onmouseover="tipMsg()">
							  ${fn:substring(resoult[list.name],0,10) }...
							  </td>
						  </c:if>

						  <c:if test="${list.mainTableColumn.propertyType ne 7 and list.mainTableColumn.propertyType ne 2 and list.mainTableColumn.propertyType ne 4 and list.mainTableColumn.propertyType ne 8 and list.mainTableColumn.propertyType ne 5 and list.mainTableColumn.propertyType ne 10 and list.mainTableColumn.propertyType ne 9}">
							  <td  width="${list.mainTableColumn.columnLength}" title="${resoult[list.name] }">
							  ${resoult[list.name] }
							  </td>
						  </c:if>
					  </c:forEach>
				     ...
				     <td  align="center" style="text-align: center;"> 
						 <tags:permission type="update" gnDm="${sessionScope.gnDm}">
				      		<a  href="javascript:modifyObject('${resoult[maintable.keyColumnName]}','${maintable.tableName }','${userid }','${opeid }');">修改</a>
						 </tags:permission>
						 <tags:permission type="read" gnDm="${sessionScope.gnDm}">
				      		<a href="javascript:viewObject('${resoult[maintable.keyColumnName]}','${maintable.tableName }');">查看</a>
						 </tags:permission>
						  <tags:permission type="delete" gnDm="${sessionScope.gnDm}">
					   	 	<a href="javascript:deleteInfoByOne('${resoult[maintable.keyColumnName]}')" style="cursor: pointer;">删除</a>
						  </tags:permission>
				    </td>   
