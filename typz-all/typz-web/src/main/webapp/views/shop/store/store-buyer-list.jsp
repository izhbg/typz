	...
	<div class="page-container">
		...
		<div class="content content-inner">
			...
			<div class="panel-body">
				...
				<a href="#this" onclick="StoreBuyer.showDialog()" class="btn btn-sm default"  ><i class="fa fa-plus-square"></i>新增</a>
				<a href="javascript:StoreBuyer.delconfirm()" class="btn btn-sm red" ><span class="glyphicon glyphicon-calendar"></span>删除</a>
				...
				<div id="collapse-group" class="collapse <c:if test="${(parameterMap.code ne null&&parameterMap.code ne '') || (parameterMap.gnjsMc ne null&&parameterMap.gnjsMc ne '') }">in</c:if> ">
					 <div class="panel panel-default" style="margin-bottom: 0px;"> 
						<div class="panel-body">
						 <form id="form1" name="form1" action="${ctx }/store/goods-buyer-list.izhbg" method="post" class="form-horizontal" >
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<button type="button" onclick="StoreBuyer.addBuyerGoods()" class="btn blue">确定</button>
					</div>
				</div>
				<!-- /.modal-content -->
			</div>
...
<script type="text/javascript" src="${ctx}/s/assets/scripts/store/store_buyer.js"></script> 
