...
public class DashboardController {
	...
	public String secondPage(@RequestParam(value = "la", required = false, defaultValue = "39.910942") Double la,
		...
		String result = null;
		try {
			TShGoodsTags tShGoodsTags = indexService.secondPage(tagId, la, lo,page);
			BeanMapper beanMapper = new BeanMapper();
			List<TShGoodsTags> tags = new ArrayList<>();
			tags.add(tShGoodsTags);
			List<com.izhbg.typz.im.goods.response.entity.TShGoodsTags> list = beanMapper.copyList(tags, com.izhbg.typz.im.goods.response.entity.TShGoodsTags.class);
